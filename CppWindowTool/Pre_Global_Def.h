...
#define EK_GUI_STARTER			1				/*界面参数：开始界面*/
#define EK_GUI_WINDOW			2				/*界面参数：窗口界面*/
#define EK_GUI_HOME				3				/*界面参数：家的界面 */
#define EK_GUI_BLACK			-1				/*界面参数：黑屏界面*/
#define EK_GUIBUTTON_NORMAL		101				/*按钮参数：开始常规*/
#define EK_GUIBUTTON_HOME		102				/*按钮参数：开始的家*/
...
RECT					WindowRectangle_Prev;								/* 全屏保留窗口时的矩形				*/
RECT					WindowRectangle_Present;							/* 任何时刻窗口在屏幕上的矩形			*/
RECT					GuiRectangle_Present;								/* 任何时刻窗口在窗口上的矩形*/
// Sub_Hook_Proc
HOOKMSG					hookmsg;											/* 回调函数中输出的消息内容（并未启用）	*/
HOOKMSG					hoommsg;											/* 回调函数中输出的消息内容（并未启用）	*/
...
ID3DXFont*				d3dFontPointer = NULL;								/* D3D字体指针						*/
